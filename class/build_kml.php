<?php
// $Id: build_kml.php,v 1.2 2008/02/26 10:51:28 ohwada Exp $

//=========================================================
// Google Ajax Maps Module
// this file include 4 classes
//   gamaps_kml_document_object
//   gamaps_kml_folder_object
//   gamaps_kml_placemarks_object
//   gamaps_build_kml
// 2008-02-17 K.OHWADA
//=========================================================

//=========================================================
// class gamaps_kml_document_object
//=========================================================
class gamaps_kml_document_object extends gamaps_xml_single_object
{

//---------------------------------------------------------
// constructor
//---------------------------------------------------------
function gamaps_kml_document_object()
{
	$this->gamaps_xml_single_object();
...
//=========================================================
// class gamaps_kml_folder_object
//=========================================================
class gamaps_kml_folder_object extends gamaps_xml_single_object
{

//---------------------------------------------------------
// constructor
//---------------------------------------------------------
function gamaps_kml_folder_object()
{
	$this->gamaps_xml_single_object();
...
//=========================================================
// class gamaps_kml_placemarks_object
//=========================================================
class gamaps_kml_placemarks_object extends gamaps_xml_iterate_object
{

//---------------------------------------------------------
// constructor
//---------------------------------------------------------
function gamaps_kml_placemarks_object()
{
	$this->gamaps_xml_iterate_object();
...
//=========================================================
// class gamaps_build_kml
//=========================================================
class gamaps_build_kml extends gamaps_build_xml
{
...
// constructor
//---------------------------------------------------------
function gamaps_build_kml()
{
	$this->gamaps_build_xml();
...
function init_obj()
{
	$this->_obj_document   = new gamaps_kml_document_object();
	$this->_obj_folder     = new gamaps_kml_folder_object();
	$this->_obj_placemarks = new gamaps_kml_placemarks_object();
}
